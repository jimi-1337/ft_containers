...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/02 15:56:25 by ayennoui          #+#    #+#             */
/*   Updated: 2021/03/02 17:53:19 by ayennoui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_print_map(ft::multimap<int, int> x)
{
	ft::multimap<int, int>::iterator it = x.begin(); 
	for (; it != x.end(); it++)
...
int main()
{
	ft::multimap<int, int> x;
	ft::pair<int, int> p(0, 2);
	ft::multimap<int, int>::iterator it;
	...
	ft::multimap<int,int>::key_compare mycomp = x.key_comp();
	...
	ft::pair<ft::multimap<int, int>::iterator, ft::multimap<int, int>::iterator> p2;
	p2 = y.equal_range(3);
    ...
    ft::multimap<int, int>::reverse_iterator rit;
    rit = y.rbegin();
    for (; rit != y.rend(); rit++)
  ...
  std::cout << "relational operators (multimap)" << std::endl;
  foo.insert (ft::make_pair('a',100));
  foo.insert (ft::make_pair('z',900));
  bar.insert (ft::make_pair('b',250));
  bar.insert (ft::make_pair('b',350));
