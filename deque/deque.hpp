...
/*   Updated: 2021/03/02 18:48:46 by amoujane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	template < class T, class Alloc = std::allocator<T> >
		class deque{
			public:
				...
				typedef ListIterator<value_type, value_type*, value_type&>                         list_iterator;
				...
				// Iterators:
				iterator begin() const {return iterator(_data->begin().getptr());}
				iterator end() const {return iterator(_data->end().getptr());}
				const_iterator cbegin() const {return iterator(_data->cbegin().getptr());}
				const_iterator cend() const {return iterator(_data->cend().getptr());}
				reverse_iterator rbegin() {return reverse_iterator(_data->rbegin().geter().getptr());}
				reverse_iterator rend() {return reverse_iterator(_data->rend().geter().getptr());}
				const_reverse_iterator crbegin(){return const_reverse_iterator(_data->crbegin().geter().getptr());}
				const_reverse_iterator crend() {return const_reverse_iterator(_data->crend().geter().getptr());}
				//Capacity
				...
				iterator insert (iterator position, const value_type& val){
					return(iterator(_data->insert(list_iterator(position.getptr()), val).getptr()));
				};
				...
				iterator erase (iterator position){
					_data->erase(list_iterator(position.getptr()));
					return (position++);
				};
